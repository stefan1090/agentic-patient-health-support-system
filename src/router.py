...
def _routing_confidence(
    ...
    if secondary_agent != "none":
        return "medium"
    if safety_level != "none" and primary_agent == "none":
        return "high"
    if primary_agent == "interpretation" and has_result_to_interpret:
        return "high"
    if primary_agent == "education" and not _asks_about_education(text):
        return "low"
    return "medium"
